...
const W0 = /^([a-z0-9.+-]+:)/i, J0 = /:[0-9]*$/, Q0 = /^(\/\/?(?!\/)[^\?\s]*)(\?[^\s]*)?$/, X0 = ["<", ">", '"', "`", " ", "\r", `
`, "	"], Y0 = ["{", "}", "|", "\\", "^", "`"].concat(X0), K0 = ["'"].concat(Y0), Uu = ["%", "/", "?", ";", "#"].concat(K0), Zu = ["/", "?", "#"], ue = 255, Hu = /^[+a-z0-9A-Z_-]{0,63}$/, ee = /^([+a-z0-9A-Z_-]{0,63})(.*)$/, Vu = {
    javascript: !0,
    "javascript:": !0
  }, Gu = {
    http: !0,
...
su.prototype.parse = function (u, e) {
  ...
  if (o && (o = o[0], t = o.toLowerCase(), this.protocol = o, c = c.substr(o.length)), (e || o || c.match(/^\/\/[^@\/]+@[^@\/]+/)) && (r = c.substr(0, 2) === "//", r && !(o && Vu[o]) && (c = c.substr(2), this.slashes = !0)), !Vu[o] && (r || o && !Gu[o])) {
    ...
    if (!b) {
      ...
      for (let k = 0, g = l.length; k < g; k++) {
        ...
        if (C && !C.match(Hu)) {
          ...
          if (!p.match(Hu)) {
            const _ = l.slice(0, k), x = l.slice(k + 1), m = C.match(ee);
    ...
    this.hostname.length > ue && (this.hostname = ""), b && (this.hostname = this.hostname.substr(1, this.hostname.length - 2));
  }
  const i = c.indexOf("#");
...
const te = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  format: Bu,
  parse: Tu
}, Symbol.toStringTag, { value: "Module" })), s0 = /[\0-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, f0 = /[\0-\x1F\x7F-\x9F]/, re = /[\xAD\u0600-\u0605\u061C\u06DD\u070F\u0890\u0891\u08E2\u180E\u200B-\u200F\u202A-\u202E\u2060-\u2064\u2066-\u206F\uFEFF\uFFF9-\uFFFB]|\uD804[\uDCBD\uDCCD]|\uD80D[\uDC30-\uDC3F]|\uD82F[\uDCA0-\uDCA3]|\uD834[\uDD73-\uDD7A]|\uDB40[\uDC01\uDC20-\uDC7F]/, zu = /[!-#%-\*,-\/:;\?@\[-\]_\{\}\xA1\xA7\xAB\xB6\xB7\xBB\xBF\u037E\u0387\u055A-\u055F\u0589\u058A\u05BE\u05C0\u05C3\u05C6\u05F3\u05F4\u0609\u060A\u060C\u060D\u061B\u061D-\u061F\u066A-\u066D\u06D4\u0700-\u070D\u07F7-\u07F9\u0830-\u083E\u085E\u0964\u0965\u0970\u09FD\u0A76\u0AF0\u0C77\u0C84\u0DF4\u0E4F\u0E5A\u0E5B\u0F04-\u0F12\u0F14\u0F3A-\u0F3D\u0F85\u0FD0-\u0FD4\u0FD9\u0FDA\u104A-\u104F\u10FB\u1360-\u1368\u1400\u166E\u169B\u169C\u16EB-\u16ED\u1735\u1736\u17D4-\u17D6\u17D8-\u17DA\u1800-\u180A\u1944\u1945\u1A1E\u1A1F\u1AA0-\u1AA6\u1AA8-\u1AAD\u1B5A-\u1B60\u1B7D\u1B7E\u1BFC-\u1BFF\u1C3B-\u1C3F\u1C7E\u1C7F\u1CC0-\u1CC7\u1CD3\u2010-\u2027\u2030-\u2043\u2045-\u2051\u2053-\u205E\u207D\u207E\u208D\u208E\u2308-\u230B\u2329\u232A\u2768-\u2775\u27C5\u27C6\u27E6-\u27EF\u2983-\u2998\u29D8-\u29DB\u29FC\u29FD\u2CF9-\u2CFC\u2CFE\u2CFF\u2D70\u2E00-\u2E2E\u2E30-\u2E4F\u2E52-\u2E5D\u3001-\u3003\u3008-\u3011\u3014-\u301F\u3030\u303D\u30A0\u30FB\uA4FE\uA4FF\uA60D-\uA60F\uA673\uA67E\uA6F2-\uA6F7\uA874-\uA877\uA8CE\uA8CF\uA8F8-\uA8FA\uA8FC\uA92E\uA92F\uA95F\uA9C1-\uA9CD\uA9DE\uA9DF\uAA5C-\uAA5F\uAADE\uAADF\uAAF0\uAAF1\uABEB\uFD3E\uFD3F\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE61\uFE63\uFE68\uFE6A\uFE6B\uFF01-\uFF03\uFF05-\uFF0A\uFF0C-\uFF0F\uFF1A\uFF1B\uFF1F\uFF20\uFF3B-\uFF3D\uFF3F\uFF5B\uFF5D\uFF5F-\uFF65]|\uD800[\uDD00-\uDD02\uDF9F\uDFD0]|\uD801\uDD6F|\uD802[\uDC57\uDD1F\uDD3F\uDE50-\uDE58\uDE7F\uDEF0-\uDEF6\uDF39-\uDF3F\uDF99-\uDF9C]|\uD803[\uDEAD\uDF55-\uDF59\uDF86-\uDF89]|\uD804[\uDC47-\uDC4D\uDCBB\uDCBC\uDCBE-\uDCC1\uDD40-\uDD43\uDD74\uDD75\uDDC5-\uDDC8\uDDCD\uDDDB\uDDDD-\uDDDF\uDE38-\uDE3D\uDEA9]|\uD805[\uDC4B-\uDC4F\uDC5A\uDC5B\uDC5D\uDCC6\uDDC1-\uDDD7\uDE41-\uDE43\uDE60-\uDE6C\uDEB9\uDF3C-\uDF3E]|\uD806[\uDC3B\uDD44-\uDD46\uDDE2\uDE3F-\uDE46\uDE9A-\uDE9C\uDE9E-\uDEA2\uDF00-\uDF09]|\uD807[\uDC41-\uDC45\uDC70\uDC71\uDEF7\uDEF8\uDF43-\uDF4F\uDFFF]|\uD809[\uDC70-\uDC74]|\uD80B[\uDFF1\uDFF2]|\uD81A[\uDE6E\uDE6F\uDEF5\uDF37-\uDF3B\uDF44]|\uD81B[\uDE97-\uDE9A\uDFE2]|\uD82F\uDC9F|\uD836[\uDE87-\uDE8B]|\uD83A[\uDD5E\uDD5F]/, l0 = /[\$\+<->\^`\|~\xA2-\xA6\xA8\xA9\xAC\xAE-\xB1\xB4\xB8\xD7\xF7\u02C2-\u02C5\u02D2-\u02DF\u02E5-\u02EB\u02ED\u02EF-\u02FF\u0375\u0384\u0385\u03F6\u0482\u058D-\u058F\u0606-\u0608\u060B\u060E\u060F\u06DE\u06E9\u06FD\u06FE\u07F6\u07FE\u07FF\u0888\u09F2\u09F3\u09FA\u09FB\u0AF1\u0B70\u0BF3-\u0BFA\u0C7F\u0D4F\u0D79\u0E3F\u0F01-\u0F03\u0F13\u0F15-\u0F17\u0F1A-\u0F1F\u0F34\u0F36\u0F38\u0FBE-\u0FC5\u0FC7-\u0FCC\u0FCE\u0FCF\u0FD5-\u0FD8\u109E\u109F\u1390-\u1399\u166D\u17DB\u1940\u19DE-\u19FF\u1B61-\u1B6A\u1B74-\u1B7C\u1FBD\u1FBF-\u1FC1\u1FCD-\u1FCF\u1FDD-\u1FDF\u1FED-\u1FEF\u1FFD\u1FFE\u2044\u2052\u207A-\u207C\u208A-\u208C\u20A0-\u20C0\u2100\u2101\u2103-\u2106\u2108\u2109\u2114\u2116-\u2118\u211E-\u2123\u2125\u2127\u2129\u212E\u213A\u213B\u2140-\u2144\u214A-\u214D\u214F\u218A\u218B\u2190-\u2307\u230C-\u2328\u232B-\u2426\u2440-\u244A\u249C-\u24E9\u2500-\u2767\u2794-\u27C4\u27C7-\u27E5\u27F0-\u2982\u2999-\u29D7\u29DC-\u29FB\u29FE-\u2B73\u2B76-\u2B95\u2B97-\u2BFF\u2CE5-\u2CEA\u2E50\u2E51\u2E80-\u2E99\u2E9B-\u2EF3\u2F00-\u2FD5\u2FF0-\u2FFF\u3004\u3012\u3013\u3020\u3036\u3037\u303E\u303F\u309B\u309C\u3190\u3191\u3196-\u319F\u31C0-\u31E3\u31EF\u3200-\u321E\u322A-\u3247\u3250\u3260-\u327F\u328A-\u32B0\u32C0-\u33FF\u4DC0-\u4DFF\uA490-\uA4C6\uA700-\uA716\uA720\uA721\uA789\uA78A\uA828-\uA82B\uA836-\uA839\uAA77-\uAA79\uAB5B\uAB6A\uAB6B\uFB29\uFBB2-\uFBC2\uFD40-\uFD4F\uFDCF\uFDFC-\uFDFF\uFE62\uFE64-\uFE66\uFE69\uFF04\uFF0B\uFF1C-\uFF1E\uFF3E\uFF40\uFF5C\uFF5E\uFFE0-\uFFE6\uFFE8-\uFFEE\uFFFC\uFFFD]|\uD800[\uDD37-\uDD3F\uDD79-\uDD89\uDD8C-\uDD8E\uDD90-\uDD9C\uDDA0\uDDD0-\uDDFC]|\uD802[\uDC77\uDC78\uDEC8]|\uD805\uDF3F|\uD807[\uDFD5-\uDFF1]|\uD81A[\uDF3C-\uDF3F\uDF45]|\uD82F\uDC9C|\uD833[\uDF50-\uDFC3]|\uD834[\uDC00-\uDCF5\uDD00-\uDD26\uDD29-\uDD64\uDD6A-\uDD6C\uDD83\uDD84\uDD8C-\uDDA9\uDDAE-\uDDEA\uDE00-\uDE41\uDE45\uDF00-\uDF56]|\uD835[\uDEC1\uDEDB\uDEFB\uDF15\uDF35\uDF4F\uDF6F\uDF89\uDFA9\uDFC3]|\uD836[\uDC00-\uDDFF\uDE37-\uDE3A\uDE6D-\uDE74\uDE76-\uDE83\uDE85\uDE86]|\uD838[\uDD4F\uDEFF]|\uD83B[\uDCAC\uDCB0\uDD2E\uDEF0\uDEF1]|\uD83C[\uDC00-\uDC2B\uDC30-\uDC93\uDCA0-\uDCAE\uDCB1-\uDCBF\uDCC1-\uDCCF\uDCD1-\uDCF5\uDD0D-\uDDAD\uDDE6-\uDE02\uDE10-\uDE3B\uDE40-\uDE48\uDE50\uDE51\uDE60-\uDE65\uDF00-\uDFFF]|\uD83D[\uDC00-\uDED7\uDEDC-\uDEEC\uDEF0-\uDEFC\uDF00-\uDF76\uDF7B-\uDFD9\uDFE0-\uDFEB\uDFF0]|\uD83E[\uDC00-\uDC0B\uDC10-\uDC47\uDC50-\uDC59\uDC60-\uDC87\uDC90-\uDCAD\uDCB0\uDCB1\uDD00-\uDE53\uDE60-\uDE6D\uDE70-\uDE7C\uDE80-\uDE88\uDE90-\uDEBD\uDEBF-\uDEC5\uDECE-\uDEDB\uDEE0-\uDEE8\uDEF0-\uDEF8\uDF00-\uDF92\uDF94-\uDFCA]/, d0 = /[ \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000]/, ne = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  Any: s0,
  Cc: f0,
  Cf: re,
  ...
  S: l0,
  Z: d0
}, Symbol.toStringTag, { value: "Module" })), ce = new Uint16Array(
  // prettier-ignore
...
function se(u) {
  var e;
  return u >= 55296 && u <= 57343 || u > 1114111 ? 65533 : (e = oe.get(u)) !== null && e !== void 0 ? e : u;
}
var A;
(function (u) {
...
class he {
  ...
  stateNumericStart(e, t) {
    return t >= e.length ? -1 : (e.charCodeAt(t) | fe) === A.LOWER_X ? (this.state = F.NumericHex, this.consumed += 1, this.stateNumericHex(e, t + 1)) : (this.state = F.NumericDecimal, this.stateNumericDecimal(e, t));
  }
  ...
  emitNumericEntity(e, t) {
    ...
    if (e === A.SEMI)
      ...
      return 0;
    return this.emitCodePoint(se(this.result), this.consumed), this.errors && (e !== A.SEMI && this.errors.missingSemicolonAfterCharacterReference(), this.errors.validateNumericCharacterReference(this.result)), this.consumed;
  }
  /**
  ...
  stateNamedEntity(e, t) {
    ...
    for (; t < e.length; t++, this.excess++) {
      ...
      if (this.treeIndex = pe(n, r, this.treeIndex + Math.max(1, c), o), this.treeIndex < 0)
        return this.result === 0 || // If we are parsing an attribute
          ...
          (c === 0 || // And there should be no invalid characters.
            be(o)) ? 0 : this.emitNotTerminatedNamedEntity();
...
function Iu(u) {
  return _e(u) === "[object String]";
}
const me = Object.prototype.hasOwnProperty;
function ke(u, e) {
  return me.call(u, e);
}
function du(u) {
...
const x0 = /\\([!"#$%&'()*+,\-./:;<=>?@[\\\]^_`{|}~])/g, ge = /&([a-z#][a-z0-9]{1,31});/gi, De = new RegExp(x0.source + "|" + ge.source, "gi"), Ce = /^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))$/i;
function Ee(u, e) {
  if (e.charCodeAt(0) === 35 && Ce.test(e)) {
...
function W(u) {
  return u.indexOf("\\") < 0 && u.indexOf("&") < 0 ? u : u.replace(De, function (e, t, n) {
    return t || Ee(e, n);
  });
}
const Ae = /[&<>"]/, ye = /[&<>"]/g, we = {
...
function j(u) {
  return Ae.test(u) ? u.replace(ye, ve) : u;
}
const Se = /[.?*+^$[\]\\(){}|-]/g;
function Be(u) {
  return u.replace(Se, "\\$&");
...
const Te = { mdurl: te, ucmicro: ne }, ze = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  arrayReplaceAt: p0,
  assign: du,
  escapeHtml: j,
  ...
  if (u.md.options.linkify)
    for (let t = 0, n = e.length; t < n; t++) {
      ...
      for (let o = r.length - 1; o >= 0; o--) {
        ...
        if (i.type === "html_inline" && (je(i.content) && c > 0 && c--, Ue(i.content) && c++), !(c > 0) && i.type === "text" && u.md.linkify.test(i.content)) {
          const a = i.content;
...
const m0 = /\+-|\.\.|\?\?\?\?|!!!!|,,|--/, He = /\((c|tm|r)\)/i, Ve = /\((c|tm|r)\)/ig, Ge = {
  c: "©",
  r: "®",
  tm: "™"
};
...
function Je(u) {
  ...
  for (let t = u.length - 1; t >= 0; t--) {
    const n = u[t];
    n.type === "text" && !e && (n.content = n.content.replace(Ve, We)), n.type === "link_open" && n.info === "auto" && e--, n.type === "link_close" && n.info === "auto" && e++;
  }
}
function Qe(u) {
  let e = 0;
...
function Xe(u) {
  ...
  if (u.md.options.typographer)
    for (e = u.tokens.length - 1; e >= 0; e--)
      u.tokens[e].type === "inline" && (He.test(u.tokens[e].content) && Je(u.tokens[e].children), m0.test(u.tokens[e].content) && Qe(u.tokens[e].children));
}
const Ye = /['"]/, Wu = /['"]/g, Ju = "’";
function iu(u, e, t) {
...
function ut(u) {
  if (u.md.options.typographer)
    for (let e = u.tokens.length - 1; e >= 0; e--)
      u.tokens[e].type !== "inline" || !Ye.test(u.tokens[e].content) || Ke(u.tokens[e].children, u);
}
function et(u) {
  let e, t;
...
function rt(u, e, t, n) {
  ...
  for (r = e + 2; r < t && !(u.sCount[r] < u.blkIndent); r++) {
    ...
    if (x || (a = Du(u, r).trim(), !a) || u.sCount[r] - u.blkIndent >= 4 || (s = Qu(a), s.length && s[0] === "" && s.shift(), s.length && s[s.length - 1] === "" && s.pop(), _ += d - s.length, _ > tt))
      break;
    if (r === e + 2) {
...
function st(u, e, t, n) {
  ...
  return d ? i = u.push("ordered_list_close", "ol", -1) : i = u.push("bullet_list_close", "ul", -1), i.markup = String.fromCharCode(l), g[1] = a, u.line = a, u.parentType = _, s && at(u, k), !0;
}
function ft(u, e, t, n) {
...
const lt = [
  ...
  "track",
  "ul"
], dt = "[a-zA-Z_:][a-zA-Z0-9:._-]*", bt = "[^\"'=<>`\\x00-\\x20]+", ht = "'[^']*'", pt = '"[^"]*"', xt = "(?:" + bt + "|" + ht + "|" + pt + ")", _t = "(?:\\s+" + dt + "(?:\\s*=\\s*" + xt + ")?)", k0 = "<[A-Za-z][A-Za-z0-9\\-]*" + _t + "*\\s*\\/?>", g0 = "<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>", mt = "<!---?>|<!--(?:[^-]|-[^-]|--[^>])*-->", kt = "<[?][\\s\\S]*?[?]>", gt = "<![A-Za-z][^>]*>", Dt = "<!\\[CDATA\\[[\\s\\S]*?\\]\\]>", Ct = new RegExp("^(?:" + k0 + "|" + g0 + "|" + mt + "|" + kt + "|" + gt + "|" + Dt + ")"), Et = new RegExp("^(?:" + k0 + "|" + g0 + ")"), H = [
  [/^<(script|pre|style|textarea)(?=(\s|>|$))/i, /<\/(script|pre|style|textarea)>/i, !0],
  [/^<!--/, /-->/, !0],
  [/^<\?/, /\?>/, !0],
  [/^<![A-Z]/, />/, !0],
  [/^<!\[CDATA\[/, /\]\]>/, !0],
  [new RegExp("^</?(" + lt.join("|") + ")(?=(\\s|/?>|$))", "i"), /^$/, !0],
  [new RegExp(Et.source + "\\s*$"), /^$/, !1]
];
function Ft(u, e, t, n) {
  let r = u.bMarks[e] + u.tShift[e], c = u.eMarks[e];
...
const ou = [
  ...
  ["table", rt, ["paragraph", "reference"]],
  ["code", nt],
  ["fence", ct, ["paragraph", "reference", "blockquote", "list"]],
  ["blockquote", it, ["paragraph", "reference", "blockquote", "list"]],
  ["hr", ot, ["paragraph", "reference", "blockquote", "list"]],
  ["list", st, ["paragraph", "reference", "blockquote"]],
  ["reference", ft],
  ["html_block", Ft, ["paragraph", "reference", "blockquote"]],
  ["heading", At, ["paragraph", "reference", "blockquote"]],
  ["lheading", yt],
  ["paragraph", wt]
];
function hu() {
...
function St(u, e) {
  let t = u.pos;
  for (; t < u.posMax && !vt(u.src.charCodeAt(t));)
    t++;
...
const $t = /^([a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)$/, jt = /^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^<>\x00-\x20]*)$/;
function Ut(u, e) {
  let t = u.pos;
...
function Gt(u, e) {
  ...
  if (r !== 33 && r !== 63 && r !== 47 && !Vt(r))
    return !1;
  const c = u.src.slice(n).match(Ct);
  if (!c)
    return !1;
  if (!e) {
    const o = u.push("html_inline", "", 0);
    o.content = c[0], Zt(o.content) && u.linkLevel++, Ht(o.content) && u.linkLevel--;
  }
  return u.pos += c[0].length, !0;
}
const Wt = /^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i, Jt = /^&([a-z][a-z0-9]{1,31});/i;
function Qt(u, e) {
  const t = u.pos, n = u.posMax;
  if (u.src.charCodeAt(t) !== 38 || t + 1 >= n) return !1;
  if (u.src.charCodeAt(t + 1) === 35) {
    const c = u.src.slice(t).match(Wt);
    if (c) {
      if (!e) {
    ...
    const c = u.src.slice(t).match(Jt);
    if (c) {
      const o = h0(c[0]);
      if (o !== c[0]) {
        if (!e) {
...
function lu(u) {
  const e = u.re = Kt(u.__opts__), t = u.__tlds__.slice();
  u.onCompile(), u.__tlds_replaced__ || t.push(ir), t.push(e.src_xn), e.src_tlds = t.join("|");
  function n(i) {
  ...
  Object.keys(u.__schemas__).forEach(function (i) {
    ...
    if (u.__compiled__[i] = s, er(a)) {
      tr(a.validate) ? s.validate = sr(a.validate) : t0(a.validate) ? s.validate = a.validate : c(i, a), t0(a.normalize) ? s.normalize = a.normalize : a.normalize ? c(i, a) : s.normalize = r0();
      return;
    }
    if (ur(a)) {
      r.push(i);
...
function v(u, e) {
  if (!(this instanceof v))
    return new v(u, e);
  e || nr(u) && (e = u, u = {}), this.__opts__ = vu({}, E0, e), this.__index__ = -1, this.__last_index__ = -1, this.__schema__ = "", this.__text_cache__ = "", this.__schemas__ = vu({}, cr, u), this.__compiled__ = {}, this.__tlds__ = or, this.__tlds_replaced__ = !1, this.re = {}, lu(this);
}
...
const V = 2147483647, I = 36, Lu = 1, eu = 26, lr = 38, dr = 700, F0 = 72, A0 = 128, y0 = "-", br = /^xn--/, hr = /[^\0-\x7F]/, pr = /[\x2E\u3002\uFF0E\uFF61]/g, xr = {
  overflow: "Overflow: input needs wider integers to process",
  "not-basic": "Illegal input >= 0x80 (not a basic code point)",
  "invalid-input": "Invalid input"
}, Fu = I - Lu, M = Math.floor, Au = String.fromCharCode;
function O(u) {
  throw new RangeError(xr[u]);
}
function _r(u, e) {
  const t = [];
  let n = u.length;
...
function w0(u, e) {
  const t = u.split("@");
  let n = "";
  t.length > 1 && (n = t[0] + "@", u = t[1]), u = u.replace(pr, ".");
  const r = u.split("."), c = _r(r, e).join(".");
  return n + c;
}
function v0(u) {
  const e = [];
...
const mr = (u) => String.fromCodePoint(...u), kr = function (u) {
  return u >= 48 && u < 58 ? 26 + (u - 48) : u >= 65 && u < 91 ? u - 65 : u >= 97 && u < 123 ? u - 97 : I;
}, n0 = function (u, e) {
  return u + 22 + 75 * (u < 26) - ((e != 0) << 5);
}, S0 = function (u, e, t) {
  let n = 0;
  for (u = t ? M(u / dr) : u >> 1, u += M(u / e); u > Fu * eu >> 1; n += I)
    u = M(u / Fu);
  return M(n + (Fu + 1) * u / (u + lr));
}, B0 = function (u) {
  const e = [], t = u.length;
  ...
  return w0(u, function (e) {
    return br.test(e) ? B0(e.slice(4).toLowerCase()) : e;
  });
}, Dr = function (u) {
  return w0(u, function (e) {
    return hr.test(e) ? "xn--" + T0(e) : e;
  });
}, z0 = {
  /**
  ...
  zero: Er,
  commonmark: Fr
}, yr = /^(vbscript|javascript|file|data):/, wr = /^data:image\/(gif|png|jpeg|webp);/;
function vr(u) {
  const e = u.trim().toLowerCase();
  return yr.test(e) ? wr.test(e) : !0;
}
...
function B(u, e) {
  if (!(this instanceof B))
    return new B(u, e);
  e || Iu(u) || (e = u || {}, u = "default"), this.inline = new cu(), this.block = new hu(), this.core = new qu(), this.renderer = new Q(), this.linkify = new v(), this.validateLink = vr, this.normalizeLink = Sr, this.normalizeLinkText = Br, this.utils = ze, this.helpers = du({}, Re), this.options = {}, this.configure(u), e && this.set(e);
}
...
const Tr = {
...
}, zr = { class: "tr-bubble__content-wrapper" }, Ir = {
  key: 1,
  class: /* @__PURE__ */ i0(["tr-bubble__content"])
}, Mr = { class: "tr-bubbule__body" }, qr = ["innerHTML"], Rr = { key: 1 }, Lr = {
  key: 2,
  ...
  setup(u) {
    ...
    const e = u, t = P0(), n = au(() => B(e.mdConfig || {})), r = au(() => e.type === "markdown" ? n.value.render(e.content) : e.content), c = au(() => e.placement === "start");
    return (o, i) => (S(), L("div", {
      class: i0([
        "tr-bubble",
        {
      ...
      e.role !== 'user' ? (S(), L("div", Tr, [
        Z("img", {
          src: new URL('/src/assets/ai-chat.gif', import.meta.url).href,
          alt: "AI Avatar",
          class: "tr-bubble__avatar-img"
        }, null, -1)
      ])) : e.avatar ? (S(), L("div", Tr, [
        (S(), yu(o0(e.avatar)))
      ])) : _u("", !0),
          ...
          Z("div", Mr, [
            mu(o.$slots, "default", { bubbleProps: e }, () => [
              e.type === "markdown" ? (S(), L("span", {
                key: 0,
                innerHTML: r.value
              }, null, 8, qr)) : (S(), L("span", Rr, O0(r.value), 1)),
              e.aborted ? (S(), L("span", Lr, "（用户停止）")) : _u("", !0)
            ], !0)
          ]),
          t.footer ? (S(), L("div", Pr, [
  ...
  setup(u) {
    ...
    const c = (i) => {
      ...
      var s;
      return { ...(i.role ? ((s = e.roles) == null ? void 0 : s[i.role]) || {} : {}).slots, ...i.slots ,...P0()};
    };
    return (i, a) => (S(), L("div", {
